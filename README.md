...
[![Édition](https://img.shields.io/badge/%C3%A9dition-sans%20SharePoint-5b6470.svg)](#)
...
Cette distribution est l'**édition sans SharePoint**. Le connecteur SharePoint / OneDrive
(navigation dans les sites, rattachement de fichiers par lien) en est absent.

Ce qui reste inchangé : l'authentification Microsoft Entra ID, la présence et l'agenda de
l'annuaire cartographié, et tout le reste de l'application. Les documents s'ajoutent par
téléversement dans Larka.

> ⚠️ Les deux éditions ne sont **pas interchangeables sur une base existante**. Cette
> distribution est destinée à une installation neuve. Une base créée avec l'édition
> complète peut contenir des documents qui ne sont que des liens SharePoint : ils
> apparaîtraient ici comme des fichiers vides.
...
│   ├── MsGraph.php         Client Microsoft Graph (présence, agenda)
│   ├── AssistantTools.php  Outils de l'assistant IA
│   └── routes/             20 modules (auth, inventaire, maintenance, urgences, assistant, …)
